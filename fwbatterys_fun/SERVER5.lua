...
if RocketPack < MaxRocketPack then
	...
	local x,y,z=getElementPosition(lp)
			triggerClientEvent(root, "startSilvesterRocket5", root, "finish5", xr, yr, zr, scale, r, g, b, a)
		local Rocket=createObject(1615,x,y,z-1,0,90,0)
	setTimer(function()
		local Rocket1=createObject(3515,x,y,z-7.5,0,0,0)
	setTimer(function()
	destroyElement(Rocket1)
end,22000,1)
end,1500,1)
	setTimer(function()
		local Rocket2=createObject(3515,x,y,z-6.5,0,0,0)
	setTimer(function()
	...
	setTimer(function()
		local Rocket4=createObject(3515,x,y,z-5.5,0,0,0)
	setTimer(function()
	destroyElement(Rocket4)
end,20000,1)
end,6500,1)
	setTimer(function()
		local Rocket5=createObject(3515,x,y,z-4.5,0,0,0)
	setTimer(function()
	destroyElement(Rocket5)
		...
		setTimer(function()
	setTimer(function()
		local Rocket7=createObject(3515,x,y,z-3.5,0,0,0)
	setTimer(function()
	destroyElement(Rocket7)
end,15500,1)
end,8000,1)
	setTimer(function()
		local Rocket8=createObject(3515,x,y,z-2.5,0,0,0)
	setTimer(function()
